---
title: "Additional Plots (Pilot)"
output: html_document
abstract: "this document contains additional plots to be added to the MetaViz + iHMP paper in progress."
---
...
This document is to provide additional figures for the HMP2 + MetaViz paper generated from the IBD Pilot HMP2 dataset.
...
pilot_biom <- load_biom("data/stool_pilot_taxonomic_profiles.biom")
biopsy_biom <- load_biom("data/biopsy_taxonomic_profiles.biom")
```

# MRexperiment Creation
